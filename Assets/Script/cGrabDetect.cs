...
public class cGrabDetect : MonoBehaviour 
{
	public bool bHit;
	public string owner;
	...
	void OnTriggerEnter (Collider opponentCol) 
	{
		...
		if (!bHit)
		{
			...
			{
				if (controller.stats.opponent.GetComponent<FighterController>().bGrounded && !controller.stats.opponent.GetComponent<FighterController>().bHit)
				{
